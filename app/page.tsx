            ...
            return (
              ...
              >
                ...
                <div className="relative z-20 container mx-auto px-6 h-full flex items-center">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full min-h-[600px]">
                    {/* Texto - Lado Esquerdo */}
                    <div className="text-center lg:text-left space-y-6 lg:space-y-8 order-2 lg:order-1 flex flex-col justify-center">
                    ...
                    <div className="flex justify-center lg:justify-center order-1 lg:order-2 relative z-50">
                      <div className="relative group">
                        <div className="w-[350px] h-[350px] md:w-[450px] md:h-[450px] lg:w-[550px] lg:h-[550px] xl:w-[600px] xl:h-[600px] relative flex items-center justify-center">
                          <Image
